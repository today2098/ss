...
# echo "> sudo apt -y install g++ python3 cmake"
...
# echo -e "sudo apt -y install doxygen graphviz imagemagick"
# sudo apt -y install doxygen graphviz imagemagick
# echo -e "sudo apt -y install texlive texlive-extra-utils texlive-latex-extra texlive-font-utils dvipng latexmk"
...
# echo -e "sudo apt -y install python3-sphinx dia"
...
echo -e "sudo apt -y install gsl-bin libgsl-dev libgslcblas0"
sudo apt -y install gsl-bin libgsl-dev libgslcblas0

# To read pcap packet traces
echo -e "sudo apt -y install tcpdump"
sudo apt -y install tcpdump

# Database support for statistics framework
echo -e "sudo apt -y install sqlite sqlite3 libsqlite3-dev"
sudo apt -y install sqlite sqlite3 libsqlite3-dev

# Xml-based version of the config store (requires libxml2 >= version 2.7)
echo -e "sudo apt -y install libxml2 libxml2-dev"
sudo apt -y install libxml2 libxml2-dev

# Support for generating modified python bindings
echo -e "sudo apt -y install cmake libc6-dev libc6-dev-i386 libclang-dev llvm-dev automake python3-pip"
sudo apt -y install cmake libc6-dev libc6-dev-i386 libclang-dev llvm-dev automake python3-pip
echo -e "python3 -m pip install --user cxxfilt"
python3 -m pip install --user cxxfilt

# A GTK-based configuration system
echo -e "sudo apt -y install libgtk-3-dev"
sudo apt -y install libgtk-3-dev

# To experiment with virtual machines and ns-3
echo -e "sudo apt -y install vtun lxc uml-utilities"
...
echo -e "sudo apt -y install libxml2 libxml2-dev libboost-all-dev"
